...
= 6.0.67 =
*  Changed: The minimum required PHP version is now 7.4

= 6.0.65 =
*  Updated: Added more debug data in logging
*  Improved: Check of image files before optimization
...
= 6.0.58 =
*  Fully refactored image optimizer plugin
